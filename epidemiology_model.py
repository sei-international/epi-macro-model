...
for i in range(0, len(geographies['geography'])):
    info = geographies['geography'][i]
    ...
    infected_arrivals = (info['international travel']['daily arrivals'] * info['international travel']['fraction infected'] * info['international travel']['duration of stay']) + (info['population'] * info['external mobility rate'])
